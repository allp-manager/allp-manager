...
use crate::domain::{DeveloperTarget, SearchScope};
...
impl Commands {
    pub fn is_mutating(&self) -> bool {
        matches!(
            self,
            Self::Install(_) | Self::Remove(_) | Self::Update(_) | Self::Upgrade(_)
        )
    }
    ...
    pub fn common(&self) -> &CommonOptions {
        match self {
            ...
            Self::Update(args) | Self::Upgrade(args) => &args.common,
    ...
    pub fn backend_filter(&self) -> Option<&str> {
        match self {
            ...
            Self::Update(args) | Self::Upgrade(args) => args.backend.backend.as_deref(),
    ...
    pub fn search_scope(&self) -> Option<SearchScope> {
        match self {
            ...
            Self::Update(args) | Self::Upgrade(args) => args.scope.scope,
            _ => None,
        }
    }
    ...
    pub fn target(&self) -> Option<DeveloperTarget> {
        match self {
            Self::Update(args) | Self::Upgrade(args) => args.target.target,
            _ => None,
        }
    }
    ...
    pub fn dry_run(&self) -> bool {
        match self {
            ...
            Self::Update(args) | Self::Upgrade(args) => args.mutation.dry_run,
            _ => false,
        }
    }
    ...
    pub fn no_interactive(&self) -> bool {
        match self {
            ...
            Self::Update(args) | Self::Upgrade(args) => args.mutation.no_interactive,
            _ => false,
        }
    }
    ...
    pub fn yes(&self) -> bool {
        match self {
            ...
            Self::Update(args) | Self::Upgrade(args) => args.mutation.yes,
            _ => false,
        }
    }
